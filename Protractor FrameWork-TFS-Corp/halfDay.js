describe('HalfDay Test', function () {
 ...
 browser.driver.manage().window().maximize();
  ...
  it('First Test', function() {
   ...
   // ptor.findElement(protractor.By.model("myCity")).click();
    ...
    ptor.sleep(2000); 	
    ptor.findElement(by.cssContainingText('option', '4hrs 40Kms')).click();
    ptor.sleep(2000); 	 
...
//.btn-info
   ...
   // ptor.findElement(by.cssContainingText('button', 'PM')).click();
    ...
    ptor.sleep(3000);   
	ptor.findElement(by.cssContainingText('option', 'Tata Indica AC')).click();
    ptor.sleep(2000);
 ...
 //   ptor.findElement(protractor.By.model("radioModel")).click();
  ...
  expect(ptor.findElement(by.xpath("//div[@class='modal-dialog']/div[1]/div[1]/h3")).getText(),'Booking Confirmed');
	...
	//Congratulations! Your Booking Successful!
