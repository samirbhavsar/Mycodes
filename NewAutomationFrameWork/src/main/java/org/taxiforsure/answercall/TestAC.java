...
public class TestAC
{
   ...
   public TestAC(WebDriver driver)
   {
	  this.driver = driver;
	  PageFactory.initElements(driver, this);
   }

//   private static String pickUpLocality = null;
//   private static String dropLocality = null;
//   private static String setDate= null;
//   private static String customerName = null;
//   private static String custPhNo = null;
//   private static String custEmail = null;
//   private static String pikUpAdress = null;
   ...
   public synchronized void clickTakeBookingButton()
   {
		...
		fluent.until(ExpectedConditions.visibilityOf(tariffTable));
    ...
    */
   public synchronized String setDayTravelAndGetTheSetDate()
   {
	  String dateToSet;
	  ...
	  new DoOperation().selectInDropDown(driver, pickUpTimeDropDown, "08:00");
   ...
   public synchronized String setNightTravelAndGetTheSetDate()
   {
	  String dateToSet;
	  log.info("Setting day travel");
	  dateToSet = getTodayDate();
	  log.info("Setting the date as " + dateToSet);
	  new DoOperation().type(driver, pickupDateField, dateToSet);
	  new DoOperation().selectInDropDown(driver, pickUpTimeDropDown, "11:00");
