...
public class Assertions {
	...
	public static void assertNull(Object condition) {
		Assert.assertNull(condition);
	}

	public static void assertNotNull(Object condition) {
		Assert.assertNotNull(condition);
	}

	public static void assertNull(Object condition, String errorMsg) {
		Assert.assertNull(condition, errorMsg);
	}

	public static void assertNotNull(Object condition, String errorMsg) {
		Assert.assertNotNull(condition, errorMsg);
	}
